		<div class="row small-spacing">
			<div class="col-lg-4 col-xs-12">
                ...
                <input type="radio" name="foto_pilih" value="upload_baru" style="display: inline;" onclick="klik_foto(2)"><label class="text-black" for="email">Upload Foto Baru</label> 
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Seri Hp</label>
								<input type="text"  class="form-control" name="seri" value="<?=$ket->seri?>" id="seri" minlength="5" required="">
							</div>
							
							<div class="form-group">
								<label for="exampleInputEmail1">Ram</label>
								<input type="text"  class="form-control" name="ram" value="<?=$ket->ram?>" id="ram" required="">
							</div>

							<div class="form-group">
								<label for="exampleInputEmail1">Internal</label>
								<input type="text"  class="form-control" name="inter" value="<?=$ket->inter?>" id="inter" required="">
							</div>

							<div class="form-group">
								<label for="exampleInputEmail1">Harga</label>
								<input type="text"  class="form-control" name="harga" value="<?=number_format($ket->harga)?>" id="num" minlength="5"required="">
							</div>
