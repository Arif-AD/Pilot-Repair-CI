<div class="main-menu">
	<header class="header">
		<a href="index-2.html" class="logo"><img src="<?=base_url()?>images/pilot_repair/logo_admin_putih.png" width="200" height="auto"></a>
		<!-- <button type="button" class="button-close fa fa-times js__menu_close"></button> -->
		<div class="user">
			<a href="#" class="avatar"><img src="<?=base_url()?>images/pilot_repair/teknisi.png" alt="" width="200" height="200"></a>
			<h4><a href="profile.html"> <img src="<?=base_url()?>images/pilot_repair/logo_admin.png" width="200" height="auto"></a></h4>
