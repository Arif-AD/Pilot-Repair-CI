...
class Admin extends CI_Controller {
	...
	function index()
	{
		if ($_SERVER['REQUEST_METHOD'] == 'POST') {
			...
			$array = array('seri' =>$seri,'ram' =>$ram,'inter' =>$inter,'ramint' =>$ramint,'harga' =>$harga, 'img' => $dir.$no.'.jpg');
			...
			$main['xiaomi'] = $this->madmin->tampil_data_where('tb_produk',array('kategori' => 2));
